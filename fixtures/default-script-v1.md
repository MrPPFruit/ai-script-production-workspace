# 《雷雨》·面试 Demo 导入版本（第四幕）V1

> 本文件保存“本次导入版本”的连续全文，范围是来源页标为“第四幕4”的终局连续片段；不是《雷雨》全剧，也不是第四幕全文。作者：曹禺。来源与使用边界见 `SOURCE_AND_LICENSE.md`。
