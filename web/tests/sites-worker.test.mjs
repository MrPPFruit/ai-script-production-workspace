...
test("emits the files required by Sites packaging", async () => {
  ...
  await access(new URL("../dist/server/breakdown-core.js", import.meta.url));
  await access(new URL("../dist/.openai/hosting.json", import.meta.url));
  const bundledWorker = await import(new URL("../dist/server/index.js", import.meta.url));
  assert.equal(typeof bundledWorker.default.fetch, "function");
});
