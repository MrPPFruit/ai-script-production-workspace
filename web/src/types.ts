...
export interface TaskRow { id: string; entityId: string; department: string; task: string; sourceSceneIds: string[]; content: string; priority: "高" | "中" | "低"; reviewStatus: TaskReviewStatus; versionLabel: string; }
